...
//           {/* Mission */}
//           <div className="relative w-96 h-96 flex flex-col justify-center items-center text-center bg-white rounded-3xl shadow-lg border-4 border-indigo-300 p-6 hover:scale-105 transition-transform duration-300">
